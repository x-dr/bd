...
async function downFile () {
  ...
  await downloadUrl();
  if ($.body) {
    url = 'https://gh.tryxd.cn/https://github.com/x-dr/jd/blob/main/old/JD_DailyBonus.js';
  } else {
...
function downloadUrl(url = 'https://gh.tryxd.cn/https://github.com/x-dr/jd/blob/main/old/JD_DailyBonus.js') {
    ...
    $.get(options, async (err, resp, data) => {
      try {
        if (err) {
          ...
          await $.http.get({url: `https://gh.tryxd.cn/https://github.com/x-dr/jd/blob/main/old/JD_DailyBonus.js`, timeout: 10000}).then((resp) => {
