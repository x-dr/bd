...
async function sendNotify(text, desp, params = {}, author = '\n\n本通知 By：小东（容器1）\n\ncookie更新/提交地址: \n\njd.ookk.me \n\n支付宝搜索 707209116 领红包') {
        ...
        try {
                ...
                if (strTitle) {
                        const notifyRemindList = process.env.NOTIFY_NOREMIND ? process.env.NOTIFY_NOREMIND.split('&') : [];                        titleIndex = notifyRemindList.findIndex((item) => item === strTitle);
                                                ...
                                                if (strCustomTempArr.length > 2) {
                                                        ...
                                                        for (let Tempk = 2; Tempk < strCustomTempArr.length; Tempk++) {
                                                                ...
                                                                case "钉钉":
                                                                        ...
                                                                        console.log("自定义设定启用钉钉机器人进行通知...");                                                                        break;
                                                                case "企业微信机器人":
...
function Env(t, s) {
        return new(class {
                ...
                msg(s = t, e = '', i = '', o) {
                        ...
                        this.logs.push('', '==============\ud83d\udce3\u7cfb\u7edf\u901a\u77e5\ud83d\udce3=============='),                        this.logs.push(s),
                        e && this.logs.push(e),
                        i && this.logs.push(i);
                }
                log(...t) {
